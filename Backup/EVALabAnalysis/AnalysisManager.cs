...
namespace EVALabAnalysis
{
    ...
    public class AnalysisManager
    {
        ...
        {
            Trial trial = FindTrial(input);
            DataList data = data = filterMngr.Filter(input, parms.CutOff, parms.Order);
            if (data!=null) trial.Data.Add(data);
        }
        ...
        {
            Trial trial = FindTrial(input);
            DataList data = data = filterMngr.Butterworth2Order50Hz(input);
            if (data != null) trial.Data.Add(data);
        }
        ...
        {
            Trial trial = FindTrial(input);
            DataList data = data = filterMngr.Denoise(input,parms.Order);
            if (data != null) trial.Data.Add(data);
        }
        ...
        public void FindFixation(DataList input, FixationParams parms)
        {
            ...
            input.Fixations = fixationMngr.DoFixation(input, maxDispersion, parms.FixationMinDuration,true);
        }
        ...
        {
            Trial trial = FindTrial(input);
            DataList data = roiMngr.Calibrate(input, rois, -50, 50, -50, 50);
            if (data != null) trial.Data.Add(data);
        }
