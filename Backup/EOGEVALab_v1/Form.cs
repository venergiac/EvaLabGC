...
namespace EvaLab.EOG
{
    ...
    public partial class Form1 : Form, IContext
    {
        ...
        void ExperimentRunner_EventRunner(object o, ExperimentRunner.ExperimentRunnerEventArgs e)
        {
            ...
            {
                buffer += e.DataValues[0] + "  " + ((e.DataValues.Length > 1) ? e.DataValues[1] : 0) + "  " + e.Time + "  " + e.CurrentExperimentItem + "  " + e.ExperimentValue + "  " + calibrationManager.ScaleCh1(e.DataValues[0]) + "  " + ((e.DataValues.Length > 1) ? calibrationManager.ScaleCh2(e.DataValues[1]) : 0) + "\n";
            ...
            if ((e.DataValues != null) && (sample % 10 == 0))
            {
        ...
        {
            Test.TestParallelForm.Show(this, this.parallelPort);
        }
