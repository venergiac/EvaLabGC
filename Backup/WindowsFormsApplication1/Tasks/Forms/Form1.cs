...
namespace EVALabGC
{
    public partial class Form1 : Form, StimulusController
    {
        ...
        protected ASL.Reader reader = null;
        ...
        public virtual int GetCurrentStimulusId(Data data)
        {
            return 0;
        }
        ...
        public virtual string GetStimulusName(int stimulusId)
        {
            return "In progress";
        }
        ...
        public void FullScreen(int screenIdx)
        {
            Screen scrn = Screen.AllScreens[screenIdx];
            FullScreen(scrn);
        }
        
        public void FullScreen(Screen scrn)
        {
            if (fullscreen == false)
            {
